param(
  ...
  # Update this fixed value whenever the derived style or vendored source changes.
  [string]$StyleUpdated = '2026-07-22T05:32:29+00:00'
)
...
$upstreamHeader = '  <!-- This file was generated by the Style Variant Builder <https://github.com/citation-style-language/style-variant-builder>. To contribute changes, modify the template and regenerate variants. -->'
$generatedHeader = @'
  <!--
    Derived from the official APA CSL.
    Generated by scripts/build-style.ps1; do not edit this file directly.
  -->
'@
$content = Replace-ExactlyOnce $content ([regex]::Escape($upstreamHeader)) `
  $generatedHeader 'generated-file notice'
...
$content = Replace-ExactlyOnce $content '<updated>.*?</updated>' `
  ("<updated>$StyleUpdated</updated>") 'style updated timestamp'
